## DeepSeek-V4-Flash native HIP deploy (Ubuntu 24.04 + ROCm 7.1+ / Strix Halo)
...
**Memory floor:** plan for **≥ 120 GiB** unified memory. Resident use is about 97–103 GiB. It cannot share the machine with [Qwen3.8-Flash-CIRU](../qwen3.8/ciru-llamacpp-rocm7-deploy.md).
...
<div align='center'>
  <img src="../../../public/images/01-deploy/ds4/decode-vs-maxctx.png" alt="DS4 decode vs max-ctx" width="90%">
</div>
...
<div align='center'>
  <img src="../../../public/images/01-deploy/ds4/prefill-ladder.png" alt="DS4 sparse prefill ladder" width="90%">
</div>
...
<div align='center'>
  <img src="../../../public/images/01-deploy/ds4/cache-hit.png" alt="DS4 cache hits" width="90%">
</div>
...
<div align='center'>
  <img src="../../../public/images/01-deploy/ds4/memory-vs-maxctx.png" alt="DS4 memory vs max-ctx" width="90%">
</div>
...
- Sister guide: [Qwen3.8-Flash-CIRU](../qwen3.8/ciru-llamacpp-rocm7-deploy.md)
