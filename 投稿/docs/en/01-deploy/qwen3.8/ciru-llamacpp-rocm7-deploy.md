## Qwen3.8-Flash-CIRU deploy (Ubuntu 24.04 + ROCm 7.1+ / Strix Halo)
...
It cannot share 128 GB unified memory with [DeepSeek-V4-Flash](../ds4/dflash-native-hip-rocm7-deploy.md).
...
<div align='center'>
  <img src="../../../public/images/01-deploy/qwen3.8/prefill-vs-official.png" alt="CIRU prefill vs official" width="90%">
</div>
...
<div align='center'>
  <img src="../../../public/images/01-deploy/qwen3.8/decode-ladder.png" alt="CIRU decode ladder caveat" width="90%">
</div>
...
<div align='center'>
  <img src="../../../public/images/01-deploy/qwen3.8/decode-workload.png" alt="CIRU decode by workload" width="90%">
</div>
...
<div align='center'>
  <img src="../../../public/images/01-deploy/qwen3.8/mtp-depth.png" alt="CIRU MTP depth sweep" width="90%">
</div>
...
<div align='center'>
  <img src="../../../public/images/01-deploy/qwen3.8/prefix-cache.png" alt="CIRU prefix cache reuse" width="90%">
</div>
...
- Sister guide: [DeepSeek-V4-Flash native HIP](../ds4/dflash-native-hip-rocm7-deploy.md)
