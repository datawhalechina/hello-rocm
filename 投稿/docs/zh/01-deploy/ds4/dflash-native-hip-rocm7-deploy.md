## DeepSeek-V4-Flash 原生 HIP 部署（Ubuntu 24.04 + ROCm 7.1+ / Strix Halo）
...
**内存门槛：** 统一内存建议 **≥ 120 GiB**。常驻约 97–103 GiB。它和下一篇 [Qwen3.8-Flash-CIRU](../qwen3.8/ciru-llamacpp-rocm7-deploy.md) **不能同时开**。
...
<div align='center'>
  <img src="../../../public/images/01-deploy/ds4/decode-vs-maxctx.png" alt="DS4 decode 不随 max-ctx 衰减" width="90%">
</div>
...
<div align='center'>
  <img src="../../../public/images/01-deploy/ds4/prefill-ladder.png" alt="DS4 sparse prefill 阶梯" width="90%">
</div>
...
<div align='center'>
  <img src="../../../public/images/01-deploy/ds4/cache-hit.png" alt="DS4 缓存命中对比" width="90%">
</div>
...
<div align='center'>
  <img src="../../../public/images/01-deploy/ds4/memory-vs-maxctx.png" alt="DS4 内存随 max-ctx 变化很小" width="90%">
</div>
...
- 同机另一条路径：[Qwen3.8-Flash-CIRU 部署](../qwen3.8/ciru-llamacpp-rocm7-deploy.md)
