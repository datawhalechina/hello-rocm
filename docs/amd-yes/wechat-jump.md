...
<div align='center'>
    <img src="/images/amd-yes/wechat-jump/wechat_jump_yolo_rocm_flow_zh.png" alt="图5.2.1 YOLOv10 微信跳一跳训练与控制闭环" width="95%">
</div>
...
<div align='center'>
    <img src="/images/amd-yes/wechat-jump/env.png" alt="环境变量配置" width="90%">
    <p>环境变量配置示例</p>
</div>
