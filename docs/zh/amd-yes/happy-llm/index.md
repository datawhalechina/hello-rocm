...
📖 [章节教程](/zh/amd-yes/happy-llm/chapter5/chapter5-hands-on-llm-building) ｜ 🚀 [执行流程与脚本说明](/zh/amd-yes/happy-llm/chapter5/)
...
📖 [章节教程](/zh/amd-yes/happy-llm/chapter6/chapter6-llm-training-workflow-practice) ｜ 🚀 [执行流程与脚本说明](/zh/amd-yes/happy-llm/chapter6/)
...
> 本项目使用 4×AMD Radeon™ AI PRO R9700（gfx1201）运行测试，其他架构请在 [00-Environment](/zh/environment/) 中替换对应的 `--index-url`。
