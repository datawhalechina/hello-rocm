...
| 本地运行（单卡） | 集群部署（多卡） |
|---------|---------|
| [🧸 toy-cli](/zh/amd-yes/toy-cli) ✅️ | [🚀 happy-llm](/zh/amd-yes/happy-llm/) ✅️ |
| [🎮 微信跳一跳](/zh/amd-yes/wechat-jump) ✅️| |
| [🎭 Chat-甄嬛](/zh/amd-yes/huanhuan-chat) ✅️| |
| [✈️ 智能旅行规划助手](/zh/amd-yes/hello-agents/) ✅️| |
| [🦞 OpenClaw 全隐私助手](/zh/amd-yes/openclaw) ✅️| |
...
📖 [开始学习 toy-cli](/zh/amd-yes/toy-cli)
...
📖 [开始学习微信跳一跳](/zh/amd-yes/wechat-jump)
...
📖 [开始学习 Chat-甄嬛](/zh/amd-yes/huanhuan-chat)

---

#### ✈️ 智能旅行规划助手

[智能旅行规划助手](/zh/amd-yes/hello-agents/) 是基于 HelloAgents 框架的智能 Agent 应用，集成 MCP 协议调用高德地图 API，在 AMD GPU 上本地运行大模型。

- **适合人群**：想学习 Agent 框架和 MCP 协议的开发者
- **难度等级**：⭐⭐⭐
- **预计时间**：2 小时

📖 [开始学习智能旅行规划助手](/zh/amd-yes/hello-agents/smart-travel-planner/amd395-helloagents-smart-travel-planner)
...
📖 [开始学习 OpenClaw](/zh/amd-yes/openclaw)
...
📖 [开始学习 Happy-LLM](/zh/amd-yes/happy-llm/)
