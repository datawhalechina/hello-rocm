...
> 本文默认学习者使用的是 AMD 395 AI PC 或其他搭载 AMD ROCm 支持的显卡设备。关于本地模型部署，请参考 [Getting Started with ROCm Deploy](/zh/deploy/)
...
- [中文详细教程](/zh/amd-yes/hello-agents/smart-travel-planner/amd395-helloagents-smart-travel-planner)
- [English Tutorial](/zh/amd-yes/hello-agents/smart-travel-planner/amd395-helloagents-smart-travel-planner)
