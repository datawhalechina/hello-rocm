...
<div align='center'>
    <img src="/docs/public/images/05-amd-yes/happy-llm/LLama2.png" alt="alt text" width="100%">
    <p>图 5.1 LLaMA2结构</p>
</div>
...
<div align='center'>
    <img src="/docs/public/images/05-amd-yes/happy-llm/llama2-attention.png" alt="alt text" width="50%">
...
def train_tokenizer(data_path: str, save_dir: str, vocab_size: int = 8192) -> None:
    ...
    # ✅ 让 tokenizers（Rust）直接读取文件
    # 优势：
    # 1. 多线程（真正吃满 CPU）
    # 2. 避免 Python json 解析瓶颈
    # 3. 不会把数据缓存进 Python 内存
    # 4. 训练速度通常提升 5~20 倍
...
<div align='center'>
    <img src="/docs/public/images/05-amd-yes/happy-llm/pretrain_dataset.png" alt="alt text" width="100%">
    <p>图5.3 预训练损失函数计算</p>
</div>
...
<div align='center'>
    <img src="/docs/public/images/05-amd-yes/happy-llm/sftdataset.png" alt="alt text" width="90%">
    <p>图5.4 SFT 损失函数计算</p>
</div>
