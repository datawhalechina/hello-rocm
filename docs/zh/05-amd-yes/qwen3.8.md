...
> **不是** stock llama.cpp，也 **不是** [DeepSeek-V4-Flash](./ds4.md) 的 lucebox `dflash_server`。普通 GGUF 加载器读不了 PLE sidecar。
...
它和 [DeepSeek-V4-Flash](./ds4.md) 抢同一块统一内存，**不能同时常驻**。
...
<div align='center'>
  <img src="../../public/images/05-amd-yes/qwen3.8/prefill-vs-official.png" alt="CIRU prefill 对比官方" width="90%">
</div>
...
<div align='center'>
  <img src="../../public/images/05-amd-yes/qwen3.8/decode-ladder.png" alt="CIRU decode 阶梯口径说明" width="90%">
</div>
...
<div align='center'>
  <img src="../../public/images/05-amd-yes/qwen3.8/decode-workload.png" alt="CIRU 不同负载 decode" width="90%">
</div>
...
<div align='center'>
  <img src="../../public/images/05-amd-yes/qwen3.8/mtp-depth.png" alt="CIRU MTP 深度扫描" width="90%">
</div>
...
<div align='center'>
  <img src="../../public/images/05-amd-yes/qwen3.8/prefix-cache.png" alt="CIRU 前缀缓存复用" width="90%">
</div>
...
- 同机另一条路径：[DeepSeek-V4-Flash 原生 HIP 部署](./ds4.md)
