...
<div align='center'>
    <img src="/docs/public/images/05-amd-yes/huanhuan-chat/huanhuan_lora_pipeline_zh.png" alt="图5.3.1 Chat-甄嬛 LoRA 微调流程" width="95%">
</div>
...
训练大概会需要 *1 ~ 3* 小时的时间，训练完成之后会在`output`目录下生成`lora`模型。可以使用以下代码进行测试：
