...
| Gemma4-E4B-LoRA | 基于 `dair-ai/emotion` 数据集微调 Gemma 4 E4B-it | [查看记录](/zh/02-fine-tune/gemma4/gemma4-e4b-lora-swanlab.md) |
...
本章主要说明微调所需的 Python 虚拟环境与训练依赖安装。ROCm 基础环境、Windows/Ubuntu 前置条件、驱动版本、Visual Studio、GPU 架构映射等更完整细节，请参考 [00-Environment](/zh/00-environment/)。
