...
```python
tokenizer = AutoTokenizer.from_pretrained('请修改我！！！/Qwen/Qwen3-0.6B')

model = AutoModelForCausalLM.from_pretrained('请修改我！！！/Qwen/Qwen3-0.6B', device_map="auto", torch_dtype=torch.bfloat16)
```
...
args = TrainingArguments(
    output_dir="./output/Qwen3_0.6B_LoRA", # 注意修改
...
swanlab_callback = SwanLabCallback(
    ...
    experiment_name="Qwen3-0.6B-LoRA-experiment"  # 注意修改
)
```
...
[图表 ｜ Qwen3-0.6B-LoRA-AMD](https://swanlab.cn/@AMD_APU/02-Fine-Tune/runs/ay5djhynjy7i96elf3ryp/chartt)
...
mode_path = '请修改我！！！/Qwen/Qwen3-0.6B'  # 注意修改
lora_path = './output/Qwen3_0.6B_LoRA/checkpoint-699' # 注意修改
