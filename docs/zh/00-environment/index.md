...
<div align='center'>
    <img src="/images/00-environment/visual_studil_c++_desktop_installer.png" alt="Visual Studio 安装勾选「使用 C++ 的桌面开发」" width="90%">
</div>
...
> 💡 其他 GPU 替换 `--index-url` 即可，对照表见 [Windows 1.5 节](#15-安装-rocm--pytorch) 或 [GPU 架构对照表](/zh/00-environment/rocm-gpu-architecture-table)。
