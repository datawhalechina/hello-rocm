...
<div align='center'>
    <img src="/docs/public/images/05-amd-yes/happy-llm/happy_llm_rocm_training_pipeline_en.png" alt="Figure 5.4.1 Happy-LLM ROCm training route" width="95%">
</div>
...
> 📖 For ROCm + PyTorch base environment installation, see [00-Environment](/00-environment/). Continue below after completing that setup.
...
> This project was tested with 4×AMD Radeon™ AI PRO R9700 (gfx1201). For other architectures, replace the `--index-url` in [00-Environment](/00-environment/).
