...
The generated result is saved as Markdown (example: [hangzhou-3-day-mcp.md](https://github.com/datawhalechina/hello-rocm/blob/main/src/05-amd-yes/hello-agents/smart-travel-planner/examples/hangzhou-3-day-mcp.md)).
...
The Chinese tutorial is available as [amd395-helloagents-smart-travel-planner-zh.md](/zh/05-amd-yes/hello-agents/smart-travel-planner/amd395-helloagents-smart-travel-planner).
