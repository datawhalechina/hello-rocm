...
<div align='center'>
    <img src="./images/openclaw_architecture.png" alt="图5.6.1 OpenClaw 平台架构" width="90%">
...
<div align='center'>
    <img src="./images/openclaw_ecosystem.png" alt="图5.6.2 OpenClaw 生态对比" width="90%">
...
<div align='center'>
    <img src="./images/openclaw_context_usage.png" alt="图5.6.3 OpenClaw 上下文占用" width="90%">
...
<div align='center'>
    <img src="./images/amd395_spec_02.png" alt="图5.6.4 AMD 395 Max 规格" width="90%">
...
<div align='center'>
    <img src="./images/lmstudio_overview.png" alt="图5.6.5 LM Studio 界面" width="90%">
...
> 关于 LM Studio 详细配置，请参考 [Getting Started with ROCm Deploy](../../01-Deploy/README.md)
...
<div align='center'>
    <img src="./images/install_01_download.png" alt="图5.6.6 ClawX 下载页面" width="90%">
...
<div align='center'>
    <img src="./images/install_02_setup_01.png" alt="图5.6.7 安装 ClawX - 开始" width="45%">
    <img src="./images/install_02_setup_02.png" alt="图5.6.7 安装 ClawX - 用户选择" width="45%">
...
<div align='center'>
    <img src="./images/install_03_location_01.png" alt="图5.6.8 选择安装位置" width="45%">
    <img src="./images/install_03_location_02.png" alt="图5.6.8 安装进行中" width="45%">
...
<div align='center'>
    <img src="./images/install_04_language.png" alt="图5.6.9 选择语言" width="90%">
...
<div align='center'>
    <img src="./images/install_05_env_check.png" alt="图5.6.10 环境检查" width="90%">
...
<div align='center'>
    <img src="./images/install_06_model_config_01.png" alt="图5.6.11 模型配置 - 自定义" width="45%">
    <img src="./images/install_06_model_config_02.png" alt="图5.6.11 模型配置 - 验证" width="45%">
...
<div align='center'>
    <img src="./images/install_07_complete.png" alt="图5.6.12 安装完成" width="90%">
...
<div align='center'>
    <img src="./images/install_08_lobster_ready.png" alt="图5.6.13 OpenClaw 就绪" width="90%">
...
<div align='center'>
    <img src="./images/install_09_web_ui.png" alt="图5.6.14 OpenClaw Web 界面" width="90%">
...
<div align='center'>
    <img src="./images/install_10_channel_01.png" alt="图5.6.15 配置频道 - 飞书" width="45%">
    <img src="./images/install_10_channel_02.png" alt="图5.6.15 配置频道 - 钉钉" width="45%">
...
<div align='center'>
    <img src="./images/summary_privacy.png" alt="图5.6.16 全隐私方案" width="90%">
